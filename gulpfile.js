...
gulp.task("scss", function() {
  ...
  return gulp
    ...
    .pipe(sass({includePaths: require('node-normalize-scss').includePaths})) // Преобразуем Sass в CSS посредством gulp-sass
    .pipe(
...
gulp.task('watch', function () {
	gulp.watch(['app/**/*.html', 'app/scss/**/*.scss', 'app/**/*.scss', 'app/img/**/*.*', 'app/fonts/**/*.*'], gulp.series('build'))
});
